...
set_window_value(AT_DATTACK, 4, AG_WINDOW_TYPE, 8);
...
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 71);
...
//set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, fx_hit2);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -43);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 97);
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 87);
