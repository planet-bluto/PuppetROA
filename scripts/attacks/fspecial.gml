...
set_attack_value(AT_FSPECIAL, AG_OFF_LEDGE, 2);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 5.5);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 107);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -28);
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 97);
