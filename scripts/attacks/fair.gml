...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 92);
...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 36);
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_Y, -61);
set_hitbox_value(AT_FAIR, 3, HG_WIDTH, 77);
