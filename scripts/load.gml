...
sprite_change_offset("hurt", 38, 32);
sprite_change_offset("hurtground", 27, 43);
sprite_change_offset("bighurt", 34, 30);
sprite_change_offset("downhurt", 31, 28);
sprite_change_offset("uphurt", 32, 34);
...
sprite_change_offset("doublejump", 34, 36);
sprite_change_offset("walljump", 0, 0);
sprite_change_offset("pratfall", 0, 0);
sprite_change_offset("land", 29, 43);
...
sprite_change_offset("fair_hurt", 126, 74);
...
sprite_change_offset("fspecial", 78, 49);
sprite_change_offset("fspecial_hurt", 156, 98);
